...
public class SqlManager {
    ...
    static final String CREAR_LLIBRE = "INSERT INTO llibres (titol, autor, isbn, editorial, any_publicacio, descripcio, sinopsi, illustrador, ruta_portada, pagines, idioma, exemplar, nota, titol_original, traductor, llista_reserva) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" ;
...
public void crearUsuari(Usuari usuari)  {
    ...
    public List<Usuari> buscarUsuaris(String args[]) throws SQLException {
    ...
    public List<Llibre> buscarLlibres(String args[]) throws SQLException {
        ...
        try {           
            ...
            if (args[4] != null && !args[4].isEmpty()) {
                consulta += (filtres ? " AND" : "") + " anyPublicacio ILIKE '%" + args[4] + "%'";
            }
            if (args[5] != null && !args[5].isEmpty()) {
            ...
            if (args[12] != null && !args[12].isEmpty()) {
                consulta += (filtres ? " AND" : "") + " titolOriginal ILIKE '%" + args[12] + "%'";
            }
